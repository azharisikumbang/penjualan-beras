...
<body class="bg-gray-50 dark:bg-gray-800" x-data="global">
    ...
    <!--                    <img src="https://flowbite-admin-dashboard.vercel.app/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo">-->
                ...
                <div class="italic text-sm text-gray-400">
                    ...
                    <span class="underline hover:text-gray-600 cursor-pointer" @click="window.location.reload()">muat ulang</span>
                </div>
            </div>
        </div>
    </nav>
                ...
                <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        <ul class="pb-2 space-y-2">
                            ...
                            <li>
                                <a href="https://flowbite-admin-dashboard.vercel.app/settings/" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">Buat Pesanan Manual</span>
                                </a>
                            </li>
                            <li>
                                <a href="https://flowbite-admin-dashboard.vercel.app/settings/" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                            ...
                            <li>
                                <a href="<?= site_url('admin/pelanggan') ?>" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">Data Pelanggan</span>
                                </a>
                            </li>
                            <li x-data="{ show: false }">
                                ...
                                <ul id="dropdown-layouts" style="display: none" class="py-2 space-y-2 bg-gray-200 rounded px-2" x-show="show">
                                    <li>
                                        <a href="<?= site_url('admin/kelola/beras') ?>" class="flex items-center py-2 pl-10 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Kelola Data Beras</a>
                                    </li>
                                    <li>
                                        <a href="<?= site_url('admin/kelola/karyawan') ?>" class="flex items-center py-2 pl-10 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">
