...
<body class="bg-gray-50  x-data=" global">
            ...
            <div class="flex items-center justify-between">
                <div class="flex">
                    ...
                    <a href="<?= site_url() ?>" class="flex text-gray-600 ml-2 md:mr-24">
                        ...
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">BUMDES
                            - Admin Panel</span>
                    </a>
                </div>
    ...
    <div class="flex pt-14 overflow-hidden bg-gray-50">
            ...
            <div class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200">
                <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:divide-gray-700">
                        <ul class="pb-2 space-y-2">
                            <li>
                                <a href="<?= site_url('admin/dashboard') ?>"
                                    class="flex font-semibold items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                            ...
                            <li>
                                <a href="<?= site_url('admin/kelola/stok') ?>"
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                                    <svg class="w-6 h-6 text-gray-500" aria-hidden="true"
                            ...
                            <li>
                                <a href="<?= site_url('admin/broadcast-promo') ?>"
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                                    <svg class="w-6 h-6 text-gray-500" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                        <path
                                ...
                                <ul id="dropdown-layouts" style="display: none"
                                    ...
                                    <li>
                                        <a href="<?= site_url('admin/kelola/beras') ?>"
                                            class="flex items-center py-2 pl-10 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Jenis
                                            Beras</a>
                                    </li>
                                    <li>
                                        <a href="<?= site_url('admin/kelola/takaran') ?>"
                                            class="flex items-center py-2 pl-10 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">
                        ...
                        <ul class="py-2 space-y-2">
                            <li>
                                <a href="<?= site_url('admin/laporan/laporan-pemasukan') ?>"
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                                    <svg class="w-6 h-6 text-gray-500" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
                                        <path
                            ...
                            <li>
                                <a href="<?= site_url('admin/laporan/laporan-penjualan') ?>"
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                                    <svg class="w-6 h-6 text-gray-500" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
                                        <path
                            ...
                            <li>
                                <a href="<?= site_url('admin/laporan/laporan-stok') ?>"
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                                    <svg class="w-6 h-6 text-gray-500" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="pt-2 space-y-2">
                            <a href="<?= site_url('admin/ganti-password') ?>"
                            ...
                            <a href="<?= site_url('logout') ?>"
                                class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                                <svg class="w-6 h-6 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor" viewBox="0 0 19 16">
                                    <path
        ...
        <div id="main" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 ml:0 transition-all">
