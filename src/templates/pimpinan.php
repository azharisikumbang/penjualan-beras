...
<body class="bg-gray-50" x-data="global">
    <nav class="fixed z-30 w-full bg-white border-b border-gray-200 dark:border-gray-700">
    ...
    <div class="flex pt-14 overflow-hidden bg-gray-50">
                ...
                <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:divide-gray-700">
                        <ul class="pb-2 space-y-2">
                            <li>
                                <a href="<?= site_url('pimpinan/beranda') ?>"
                            ...
                            <li>
                                <a href="<?= site_url('pimpinan/laporan-pemasukan') ?>"
                            ...
                            <li>
                                <a href="<?= site_url('pimpinan/laporan-penjualan') ?>"
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                                    <svg class="w-6 h-6 text-gray-500" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
                                        <path
                            ...
                            <li>
                                <a href="<?= site_url('pimpinan/laporan-stok') ?>"
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                                    <svg class="w-6 h-6 text-gray-500" aria-hidden="true"
                            ...
                            <li>
                                <a href="<?= site_url('pimpinan/laporan-pelanggan') ?>"
                                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group">
                                    <svg class="w-6 h-6 text-gray-500" aria-hidden="true"
                                    ...
                                    <span class="ml-3" sidebar-toggle-item="">Unduh Data Pelanggan</span>
                                </a>
                            </li>
                        </ul>
                        <div class="pt-2 space-y-2">
                            <a href="<?= site_url('pimpinan/ganti-password') ?>"
        ...
        <div id="main" class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 transition-all mb-8">
