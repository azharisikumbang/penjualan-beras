        ...
        <div class="grid grid-cols-3 gap-4">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <template x-for="(item, index) in properties.data.list_beras" :key="index">
                                <tr>
                                    ...
                                    <td class="p-4 text-gray-500 text-base text-center" x-text="currencyToRupiah(item.harga)"></td>
                                    <td class="p-4 text-gray-500 text-base text-center"><span x-text="item.stok"></span> Kg</td>
            ...
            <div>
                <form @submit.prevent="simpanData" class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                    ...
                    <div class="mb-4">
                        <label for="first-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga Satuan</label>
                        <input x-model="properties.form.harga" type="number" class="shadow-sm bg-gray-50 border-2 border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-gray-500 outline-none block w-full p-2.5" min="0" value="0" required>
                    </div>
                    <div class="mb-4">
                        <label for="first-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stok Tersedia</label>
                        <input x-model="properties.form.stok" type="number" class="shadow-sm bg-gray-50 border-2 border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:border-gray-500 outline-none block w-full p-2.5" min="0" required>
                    </div>
